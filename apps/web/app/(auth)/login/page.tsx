    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-muted text-sm">Sign in to seek Krishna&apos;s wisdom</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="email" className="block text-xs text-muted mb-1.5 font-semibold uppercase tracking-wider">
              Email
            </label>
            <input
              id="email"
              ...
              className="w-full bg-white border border-border rounded-xl px-4 py-3
                text-sm text-deep-brown placeholder:text-muted/40
          ...
          <div>
            <label htmlFor="password" className="block text-xs text-muted mb-1.5 font-semibold uppercase tracking-wider">
              Password
            </label>
            <input
              id="password"
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-saffron to-saffron-dark
              ...
              transition-all duration-200 active:scale-[0.98] shadow-warm-md
              tracking-wide"
          >
        ...
        <p className="text-center text-sm text-muted">
          ...
          <Link href="/register" className="text-saffron hover:text-saffron-dark font-medium transition-colors">
            Register
          </Link>
        </p>
      </div>
